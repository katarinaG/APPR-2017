...
1. stolpec "Name" (integer): ime

2. stolpec "Gender"(character): spol

3. stolpec "Country"(character): država

4. stolpec "Year"(double): leto

5. stolpec "Time"(double): čas
...
```{r n1, echo=FALSE, fig.align='center'}
napovedi
```
